...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['email'])) {
    ...
    if ($status == "OK") {
      ...
      $query = "SELECT * FROM admin WHERE (email = '". mysqli_real_escape_string($con, $_POST['email']) . "') AND (password = '" . mysqli_real_escape_string($con, $_POST['password']) . "')";
  ...
  $errormsg= "
  <p class='alert alert-danger alert-dismissible alert-outline fade show'>
                   Username Or Password Does Not Match.
                      </p>"; //printing error if found in validation
...
<style type="text/css">
    ...
    <form  class="log-in" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"], ENT_QUOTES, "utf-8"); ?>" method="post"> 
      <h4>We are <span>SalesBoard</span></h4>
